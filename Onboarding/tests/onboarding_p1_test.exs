...
defmodule BrowsableFaqsTest do
  ...
  test "Onboarding p1 Intro & Welcome" do
    ...
    # The flow starts with a welcome message.
    ...
    |> receive_message(%{
      ...
      list_items: [
        ["@button_labels[0]", "Getstarted"],
        ["@button_labels[1]", "Change my language"]
      ]
    })

    # Privacy policy.
    |> FlowTester.continue_flow!(button_label: "Getstarted")
    # |> FlowTester.continue_flow!(button_index: 0)
    |> block_matches(%{
      name: "privacy_policy",
      type: "MobilePrimitives.SelectOneResponse"
    })
