...
```stack
trigger(on: "MESSAGE RECEIVED") when has_only_phrase(event.message.text.body, "breastfeeding")
...
We record the final result of the Form, and display the correct End page (high, medium, low). Image messages are supported.
