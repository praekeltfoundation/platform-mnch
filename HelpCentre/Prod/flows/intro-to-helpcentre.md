...
card DisplayFAQTopicsList, then: ValidateFAQSelection do
  ...
  schedule_stack("986496ff-13d1-4e30-bb59-9fbd6b091c32", in: 900)

  log(
    "Scheduled stack `HC: Scheduled - Topics No Response followup - 986496ff-13d1-4e30-bb59-9fbd6b091c32` to run in 15 minutes"
  )
...
card ValidateFAQSelection when selected_faq > 0 and selected_faq < 6, then: DisplayFAQ do
  log("Get FAQ Article")
  cancel_scheduled_stacks("986496ff-13d1-4e30-bb59-9fbd6b091c32")

  log(
    "Valid FAQ Topic List input received. Cancelling previously scheduled stack `HC: Scheduled - Topics no response follow-up - 986496ff-13d1-4e30-bb59-9fbd6b091c32`"
  )
end
...
card HelpdeskOpen do
  ...
  log("Attach Label Result = @attach_label_result")
  run_stack("57421279-34e6-4c0a-ae25-7dbf62394367")
end
